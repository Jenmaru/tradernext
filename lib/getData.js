...
export async function getTickers() {
  ...
  return await axios.get('https://iss.moex.com/iss/statistics/engines/futures/markets/forts/series.json').then((response) => response.data.series.data);
};
...
async function getLocalData() {
  ...
  const filePath = path.join(process.cwd(), 'lib/2024sort.json');
